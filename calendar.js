...
button.on("click", changeDivColor);
...
function changeDivColor(value) {
  // alert(value);
    ...
    if (value=='sad') {
      document.getElementById('day1').style.backgroundColor = "darkblue";
    }
    if (value=='angry') {
      document.getElementById('day1').style.backgroundColor = "red";
    }
    if (value=='stressed') {
      document.getElementById('day1').style.backgroundColor = "orange";
    }
    if (value=='relaxed') {
      document.getElementById('day1').style.backgroundColor = "purple";
    }
};
